...
public static class Queries
{
    ...
    public static string InsertQuestion1IntoTrigonometry = "INSERT INTO Flashcards(Id, Question, Answer, TopicId) VALUES (20, 'What is Pythagora''s Theorem?', 'a^2 + b^2 = c^2', 5)";
